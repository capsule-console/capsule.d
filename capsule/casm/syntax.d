...
auto getCapsulePseudoInstructionArgs(
    ...
    switch(type) {
        ...
        case Type.LoadByteSignExt: return Args.LoadFromAddress;
        case Type.LoadByteZeroExt: return Args.LoadFromAddress;
        case Type.LoadHalfWordSignExt: return Args.LoadFromAddress;
        case Type.LoadHalfWordZeroExt: return Args.LoadFromAddress;
        case Type.LoadWord: return Args.LoadFromAddress;
        case Type.StoreByte: return Args.StoreToAddress;
        case Type.StoreHalfWord: return Args.StoreToAddress;
        case Type.StoreWord: return Args.StoreToAddress;
